...
#'
check.plot.MB.arg <- function(choice,nature,nature.supp,supp.var, comp, nb.comp){
  if (!(choice %in% c("screeplot","numeric","qualitative","quantif","ind","quali.supp","mixed","squared.loading","blocs"))){
